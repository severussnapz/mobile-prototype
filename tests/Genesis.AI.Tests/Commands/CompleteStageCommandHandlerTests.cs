...
public class CompleteStageCommandHandlerTests
{
    ...
    {
        return Artefact.CreateS3Artefact(projectId, 1, "requirements.md", "projects/key/artefacts/requirements.md/v1", "text/markdown", 9, "user-1", TimeProvider.System, true);
    }
}
